...
<head>
    ...
    <title>{{__("main.admin_panel")}}</title>
...
<div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-sm-inline-block">
                <a href="{{route("/")}}" class="nav-link">{{__("admin.home")}}</a>
            </li>
        </ul>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="{{route("admin")}}" class="brand-link">
            ...
            <span class="brand-text font-weight-light">{{__("main.admin_panel")}}</span>
        </a>
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                <div class="info">
                    <b class="d-block text-white">{{\Illuminate\Support\Facades\Auth::user()->name}}</b>
                </div>
            </div>
    ...
    <div class="content-wrapper px-4 py-2" style="min-height: 329px">
